...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			@if(Auth::user()->role == 1)<li @if(Route::getCurrentRoute()->getPath() == Auth::user()->roleData->prefix.'/paket') class="active" @endif><a href="{{ url('/admin/paket') }}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Paket Pembayaran</a></li> @endif
